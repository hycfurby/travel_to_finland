...
function ensureEngine(){
 ...
 enginePromise=new Promise((resolve,reject)=>{
  if(!document.getElementById('maplibre-css')){const l=document.createElement('link');l.id='maplibre-css';l.rel='stylesheet';l.href='assets/nordic-v3/maplibre-gl.css';document.head.append(l);}
  const sc=document.createElement('script');sc.src='assets/nordic-v3/maplibre-gl.js';sc.async=true;
